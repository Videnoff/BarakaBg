namespace BarakaBg.Data.Migrations
{
    ...
    public partial class CountriesSeeder : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayForm = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShoppingBagId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ShoppingBagId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingBagProducts", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingBagProducts_IsDeleted",
                table: "ShoppingBagProducts",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_ShoppingBagProducts_ProductId",
                table: "ShoppingBagProducts",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingBags_IsDeleted",
                table: "ShoppingBags",
                column: "IsDeleted");
