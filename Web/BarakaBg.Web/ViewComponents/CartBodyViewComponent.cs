namespace BarakaBg.Web.ViewComponents
{
    ...
    public class CartBodyViewComponent : ViewComponent
    {
        ...
        public CartBodyViewComponent(IShoppingBagService shoppingBagService, ITextService textService)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            if (products != null)
            {
                ...
                {
                    product.ProductName = this.textService.TruncateAtWord(product.ProductName, 15);
                }
            }
